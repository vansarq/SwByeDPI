...
final class PlistUtil
{
    static func parsePropertyList<T:Codable>(filename plist_name: String) -> T?
    {
        let type = "plist"
        do
        {
    ...
    static func savePropertyList<T:Codable>(_ value: T, filename plist_name: String) -> Bool
    {
        let type = "plist"
        do
        {
