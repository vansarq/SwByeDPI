...
/// Generated domains from GoogleVideoTestDomains.domains
public final class GoogleVideoTestDomains {
  /// Domains list
  public static let domainsList = SBDDomainList(name: "GoogleVideoTestDomains", domains: Set<String>([
