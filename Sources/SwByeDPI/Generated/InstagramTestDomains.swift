...
/// Generated domains from InstagramTestDomains.domains
public final class InstagramTestDomains {
  /// Domains list
  public static let domainsList = SBDDomainList(name: "InstagramTestDomains", domains: Set<String>([
      "meta.com",
      "instagram.com",
